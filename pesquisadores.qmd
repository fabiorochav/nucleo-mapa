...
<div class="researchers-grid">
  <article class="researcher-card">
    <div class="researcher-photo">
      <img class="researcher-photo-contained" src="assests/researchers/fabio.png" alt="Fabio Rocha">
    </div>
  ...
  <article class="researcher-card">
    <div class="researcher-photo">
      <img class="researcher-photo-contained" src="assests/researchers/caio.png" alt="Caio Sousa">
    </div>
    <div class="researcher-body">
      <h3 class="researcher-name">Caio Sousa</h3>
      <p class="researcher-bio">Engenheiro de Produção (UFRJ) e Mestre em Economia (UFABC), com experiência no mercado financeiro, possui trajetória em análise de dados, macroeconomia, microeconometria e avaliação de políticas públicas. Atualmente atua como consultor temporário do Banco Interamericano de Desenvolvimento (BID).</p>
      <div class="researcher-links">
