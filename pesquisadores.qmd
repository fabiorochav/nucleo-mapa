...
<div class="researchers-grid">
  <article class="researcher-card">
    ...
    <div class="researcher-body">
      ...
      <p class="researcher-bio">Economista(UFOP), Mestre em Economia(UFABC) e filósofo(UFOP) com trajetória em monitoramento, avaliação e produção de evidências para políticas públicas de educação.</p>
  ...
  <article class="researcher-card">
    ...
    <div class="researcher-body">
      ...
      <p class="researcher-bio">Engenheiro de Produção (UFRJ) e Mestre em Economia(UFABC), com experiência no mercado financeiro, possui trajetória em análise de dados, macroeconomia, microeconometria e avaliação de políticas públicas.">
